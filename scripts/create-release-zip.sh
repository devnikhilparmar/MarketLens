...
ZIP_NAME="MarketLensTemplate.zip"
...
dotnet clean src/MarketLens.slnx -c Debug --verbosity quiet 2>/dev/null
dotnet clean src/MarketLens.slnx -c Release --verbosity quiet 2>/dev/null
